    ...
    <div className="min-h-screen bg-[#F8FAFC] p-6 font-sans text-gray-800">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between mb-6 gap-4">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900 mb-1">Update Employee Management</h1>
            <div className="text-sm text-gray-500 flex items-center gap-2">
              <span className="hover:text-[#0E9384] cursor-pointer transition-colors">Dashboard</span>
              <span>›</span>
              <span className="text-gray-400">Update Employee</span>
            </div>
          </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  <select 
                    ...
                    disabled 
                    className="w-full h-10 px-3 text-sm text-gray-500 bg-gray-50 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-[#0E9384] appearance-none cursor-not-allowed"
                  >
