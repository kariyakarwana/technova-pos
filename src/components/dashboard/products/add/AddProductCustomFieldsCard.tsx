...
interface AddProductCustomFieldsCardProps {
  warranties: boolean;
...
export default function AddProductCustomFieldsCard({
  warranties,
  onWarrantiesChange,
  manufacturer,
  ...
  expiryDate,
  onExpiryDateChange,
}: AddProductCustomFieldsCardProps) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full h-9 rounded-lg border border-[var(--brand-stroke)] px-3 text-xs text-[var(--brand-black-font)] bg-white focus:outline-none focus:border-[var(--brand-green)]"
                />
              </div>
              <div>
                <label className="block text-xs font-semibold text-[var(--brand-black-font)] mb-1">
