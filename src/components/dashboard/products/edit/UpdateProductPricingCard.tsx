...
interface UpdateProductPricingCardProps {
...
export default function UpdateProductPricingCard({
  productType,
  onProductTypeChange,
  quantity,
  onQuantityChange,
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="0.00"
                  className="w-full h-10 rounded-xl border border-[var(--brand-stroke)] pl-7 pr-3 text-xs text-[var(--brand-black-font)] placeholder:text-slate-400 bg-white focus:outline-none focus:border-[var(--brand-green)]"
                />
              </div>
            </div>
            <div>
