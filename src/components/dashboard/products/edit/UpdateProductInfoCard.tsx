...
interface UpdateProductInfoCardProps {
  productName: string;
...
export default function UpdateProductInfoCard({
  productName,
  onProductNameChange,
  slug,
  onSlugChange,
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  className="w-full h-10 rounded-xl border border-[var(--brand-stroke)] pl-3 pr-24 text-xs text-[var(--brand-black-font)] placeholder:text-slate-400 bg-white focus:outline-none focus:border-[var(--brand-green)]"
                />
                <button
                  type="button"
                  onClick={onGenerateSku}
                  className="absolute right-1.5 h-7 px-3 rounded-lg bg-[var(--brand-green)] text-white text-[11px] font-semibold hover:opacity-90 transition-opacity cursor-pointer"
                >
                  Generate
                </button>
              </div>
