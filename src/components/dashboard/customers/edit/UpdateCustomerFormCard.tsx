...
interface UpdateCustomerFormCardProps {
  customerId: string;
...
export default function UpdateCustomerFormCard({
  customerId,
  onCustomerIdChange,
  firstName,
  onFirstNameChange,
      ...
      {!isCollapsed && (
        <div className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-slate-700">
                First Nme <span className="text-red-500">*</span>
              </label>
              <input
                type="text"
                required
