...
interface InventoryProductListPaginationProps {
  currentPage: number;
  totalPages: number;
  rowsPerPage: number;
...
export default function InventoryProductListPagination({
  currentPage,
  totalPages,
  rowsPerPage,
  onPageChange,
  onRowsPerPageChange,
}: InventoryProductListPaginationProps) {
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 mt-2 border-t border-[var(--brand-stroke)] text-xs text-[var(--brand-muted-font)]">
